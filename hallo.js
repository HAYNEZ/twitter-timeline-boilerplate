...
(function($) {
  ...
  //
	...
	var tweetPicTemplate = '<li class="pics">USERPICTURES</li>';
	var $container = null;
	...
	function loadUserpics(searchTerm){
		var rows = 8;
	...
	function setPictures(data){
		...
		for (var i = 0; i < tweets.length; i++){
			...
			var tweet = tweetPicTemplate
				.replace('USERPICTURES', '<img class="tweetPic" src="'+tweets[i].profile_image_url+'"/>');
